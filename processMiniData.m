...
maxN = 1600;
cameraOffset = 400; %hamamatsu cameras have an offset of 100 per pixel, 400 for 2x2 binning
...
[b2,a2] = butter(4, 0.08, 'high'); % highpass filter for generating correlation image
